...
import (
	qrv2 "github.com/Mictilt/go-qrcode/v2"
	"github.com/Mictilt/go-qrcode/writer/standard"

	qrv1 "github.com/Mictilt/go-qrcode"
)

func main() {
	// draw a QRCode image with
	// - "https://github.com/Mictilt/go-qrcode" source text
	// - circle shape
...
func v1() {
	...
	qrc, err := qrv1.NewWithConfig("https://github.com/Mictilt/go-qrcode", encodeConfig,
...
func v2() {
	qrc, err := qrv2.NewWith("https://github.com/Mictilt/go-qrcode",
